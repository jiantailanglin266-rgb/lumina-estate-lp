      ...
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            ...
            <p className="mt-2 text-[10px] tracking-[0.3em] text-brand">
              REAL ESTATE
            </p>
          ...
          <div className="md:col-span-3">
            <p className="text-[10px] tracking-[0.3em] text-brand">SITE MAP</p>
            <ul className="mt-6 space-y-3">
              {navItems.map((item) => (
                <li key={item.href}>
                  <a
                    href={item.href}
                    className="text-sm text-mist transition-colors duration-300 hover:text-brand"
                  >
                    {item.label}
                  </a>
                </li>
          ...
          <div className="md:col-span-4">
            <p className="text-[10px] tracking-[0.3em] text-brand">CONTACT</p>
            <a
            ...
            <a
              href="#contact"
              className="mt-8 inline-flex items-center gap-2 border border-brand px-6 py-3 text-xs tracking-[0.12em] text-brand transition-all duration-300 hover:bg-brand hover:text-ink"
            >
              無料相談する
